...
def main():
    ...
    persist_directory: str = args.output_dir if len(args.output_dir) else os.environ.get('PERSIST_DIRECTORY2', 'db_artist_books')
    source_directory: str = args.source_dir if len(args.source_dir) else os.environ.get('SOURCE_DIRECTORY2', 'PieterBruegel_Information')
